...
function __OriginkitBase_LiquidGlassButton(props) {
    const {
        label = "GLASS BUTTON",
        font = { fontFamily: "Inter", fontWeight: 600, fontSize: 14 },
        showText = true,
        padding = "10px 24px",
        rounded = 38,
        fill: fillProp,
...
// CORES CUSTOMIZADAS PARA O PORTFÓLIO: TONS DE ZINC + ESMERALDA
const __originkitPresetProps = {
  "colors": {
    "fill": "rgba(39, 39, 42, 0.4)", // zinc-800
    "textColor": "#FFFFFF"
  },
  "icon": {
    "side": "left",
  ...
  "stroke": {
    "type": "gradient",
    "angle": 180,
    "color": "rgba(52, 211, 153, 0.15)", // emerald-400 com 15% opacidade
    "width": 1.5,
    "colorA": "rgba(52, 211, 153, 0.7)", // emerald-400 mais vivo
    "colorB": "rgba(52, 211, 153, 0.1)"
  },
  "light": {
    "size": 60, // Foco da lanterna no botão
    "color": "rgba(52, 211, 153, 0.35)", // Luz Esmeralda!
    "intensity": 100,
    "smoothness": 65
  }
};
